...
- **Contents:**
  ...
  - `.github/agents/design-agent.md` + `.github/agents/design-agent.prompt.md`
  - `.github/agents/build-agent.md` + `.github/agents/build-agent.prompt.md`
  - `.github/agents/review-agent.md` + `.github/agents/review-agent.prompt.md`
  - `.github/context/.project-context.md` (consolidated architecture)
  - `.github/context/.coding-standards.md` (unified style guide)
  - `.github/context/.security-checklist.md` (risk inventory)
